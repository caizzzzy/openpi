...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotDianaDataConfig(
            repo_id="lerobot_dataset_0405_pi0",
            assets=AssetsConfig(
                assets_dir="./assets/pi0_diana_pick_place",
                asset_id="lerobot_dataset_0405_pi0",
            ),
            base_config=DataConfig(
                local_files_dir="./datasets/lerobot_dataset_0405_pi0",
                local_video_keys=("observation.images.cam_high", "observation.images.cam_global"),
    ...
    TrainConfig(
        name="pi05_diana_pick_place_lora",
        wandb=WandBConfig(
            project="openpi",
            entity="scut-au-415",
            mode="online",
    ...
    TrainConfig(
        name="pi0_fast_diana_pick_place",
        wandb=WandBConfig(
            project="openpi",
            entity="scut-au-415",
            mode="online",
    ...
    TrainConfig(
        name="pi0_fast_diana_pick_place_lora",
        wandb=WandBConfig(
            project="openpi",
            entity="scut-au-415",
            mode="online",
